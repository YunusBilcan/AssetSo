...
const Dashboard: React.FC<DashboardProps> = ({ products, onNavigate, onBulkUpdate }) => {
      ...
      <header className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 px-6 py-2.5 rounded-xl font-medium transition-all shadow-sm"
          >
            <ICONS.Edit />
            Bulk Price Update
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-indigo-900 rounded-2xl p-8 text-white flex flex-col justify-between shadow-xl relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="mt-3 text-[10px] text-indigo-300 font-bold">Format: sku, price, reason (optional)</p>
          </div>
